...
Welcome to `BioAlloyRAG` contributor's guide.
...
If you experience bugs or general issues with `BioAlloyRAG`, please have a look
...
You can help improve `BioAlloyRAG` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`BioAlloyRAG` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `BioAlloyRAG`'s files. While this mechanism can
...
```
conda create -n BioAlloyRAG python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/BioAlloyRAG.git
   cd BioAlloyRAG
   ```
...
5. Install [pre-commit]:
   ...
   `BioAlloyRAG` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/BioAlloyRAG
[issue tracker]: https://github.com/<USERNAME>/BioAlloyRAG/issues
